...
| -------------------- | --------------------------------- | ----------------------------- | -------------------------------------- | --------------------------------------------- |
| **API Tier**         | Cloud Run / Cloud Functions       | Lambda, ECS/Fargate, EKS      | Functions, Container Apps, AKS         | [CCC.VM](/services/compute/virtual-machines/) |
| **Compute Tier**     | Vertex AI, Cloud Run              | EC2 GPU, SageMaker            | NC-series VMs, Azure AI Studio         | [CCC.VM](/services/compute/virtual-machines/) |
| **Data Tier**        | Cloud SQL, AlloyDB, Cloud Storage | Aurora, RDS, S3               | Azure SQL, Postgres flex, Blob Storage | [CCC.RDMS](/services/database/relational/)    |
...
| **Embedding Generation**      | Vertex AI Text Embeddings, OpenAI endpoints | Bedrock (text-embedding-3)                              | Azure OpenAI "text-embedding-3", Azure AI Studio | [CCC.GenAI](/services/ai-ml/gen-ai/)      |
| **Generative Model Endpoint** | Vertex AI Gemma, GPT-4o                     | Bedrock (Claude, GPT-4o, Mistral)                       | Azure OpenAI GPT-4o/4-Turbo                      | [CCC.GenAI](/services/ai-ml/gen-ai/)      |
| **Model Evaluation**          | Vertex AI Evaluations                       | Bedrock Model Evaluation, SageMaker Clarify             | Azure AI Content Safety + Prompt Flow eval       | [CCC.MLDE](/services/ai-ml/mlde/)         |
...
| **Private Networking**     | VPC, Private Service Connect          | VPC, PrivateLink                                         | VNet, Private Endpoint         | [CCC.VPC](/services/networking/vpc/)              |
...
| **Secrets Management**  | Secret Manager                       | Secrets Manager                          | Key Vault                                   | [CCC.KeyMgmt](/services/crypto/key/) |
...
| **Component**                 | **Google Cloud**           | **Amazon Web Services (AWS)** | **Microsoft Azure** | **CCC Service**                                   |
| ----------------------------- | -------------------------- | ----------------------------- | ------------------- | ------------------------------------------------- |
| **Multi-Agent Orchestration** | LangGraph, Semantic Kernel | LangGraph, Semantic Kernel    | Semantic Kernel     | [CCC.GenAI](/services/ai-ml/gen-ai/)              |
| **API Governance**            | Apigee                     | API Gateway                   | API Management      | [CCC.Message](/services/app-integration/message/) |
