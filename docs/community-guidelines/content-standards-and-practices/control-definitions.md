...
To maintain consistency, all controls— whether common or specific— must follow the same format, style, and tone. Each control should adhere to the [control style guide](../../../style-guides/catalogs/control-style-guide.yaml) before release.
...
[core controls]: /catalogs/core/core/controls.yaml
