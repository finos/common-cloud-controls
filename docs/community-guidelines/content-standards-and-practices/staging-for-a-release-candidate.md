...
2. **Add Any Missing Common Threats**
   - Review the [shared-threats.yaml](/catalogs/core/core/threats.yaml) to see the full list of common threats.
...
2. **Add Any Missing Common Controls**
   - Review the [core controls](/catalogs/core/core/controls.yaml).
...
- **Common Threats**
  [core/threats.yaml](/catalogs/core/core/threats.yaml)

- **Common Controls**
  [core/controls.yaml](/catalogs/core/core/controls.yaml)
