...
- Create a PR with a draft charter which follows the structure of an existing working group charter (for example [Communications WG](communications/charter.md)).
