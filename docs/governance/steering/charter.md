...
* Define and enforce requirements for community groups<sup>[3](#footnote3)</sup> to ensure ongoing positive standing, or decomission any groups not in good standing.
...
Our [election policy document][/steering-elections.md] covers the details for how this works.
...
[Eligible voters][voter-eligibility] from the most recent election will vote in the special election i.e., eligibility will not be redetermined at the time of the special election.
...
The call for a vote of no confidence will happen in a public Steering Committee meeting and must be documented as a GitHub issue in the committee's [repository][steering-repo].
...
Members of the committee must take the [Inclusive Open Source Community Orientation](course) course
