          ...
          <CardContent>
            <div className="space-y-4">
              <div className="flex items-center gap-2">
                ...
                <a href={`https://github.com/finos/common-cloud-controls/releases/tag/${metadata.id}-${release?.version}`} target="_blank" rel="noopener noreferrer" className="text-primary hover:underline flex items-center gap-1">
