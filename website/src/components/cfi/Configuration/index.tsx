...
export default function CFIConfiguration({ pageData }: { pageData: ConfigurationPageData }): React.ReactElement {
  ...
  const { cfi_details, source_details, results_destination, results_config_folder } = configuration;
        ...
        <Card>
          ...
          <CardContent>
            <Table>
              <TableBody>
                <TableRow>
                  <TableCell className="font-medium w-32">Test data folder</TableCell>
                  <TableCell>
                    <code className="bg-gray-100 px-2 py-1 rounded text-sm">{results_destination}</code>
                    <span className="text-muted-foreground text-sm">
                      {" "}
                      / <code className="bg-gray-50 px-1 rounded text-sm">{results_config_folder}</code>
                    </span>
                  </TableCell>
                </TableRow>
                {source_details ? (
                  <>
                    <TableRow>
                      <TableCell className="font-medium">Repository description</TableCell>
                      <TableCell>{source_details.repository_description}</TableCell>
                    </TableRow>
                    <TableRow>
                      <TableCell className="font-medium">Repository URL</TableCell>
                      <TableCell>
                        <a
                          href={source_details.repository_url}
                          target="_blank"
                    ...
                    <TableRow>
                      ...
                      <TableCell>{source_details.branch}</TableCell>
                    </TableRow>
                    <TableRow>
                      <TableCell className="font-medium">CI artifact created</TableCell>
                      <TableCell>
                        <time dateTime={source_details.artifact_created_at}>{formatGeneratedAt(source_details.artifact_created_at)}</time>
                      </TableCell>
                    </TableRow>
                    <TableRow>
                      <TableCell className="font-medium">Fetched for site</TableCell>
                      <TableCell>
