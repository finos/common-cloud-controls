...
resource "aws_vpc" "cn03_allowed_01" {
  ...
  tags = merge(var.common_tags, {
    Name      = "finos-ccc-integration-${var.deployment_suffix}-vpc-cn03-allowed-01"
    PeerClass = "allowed"
  })
}
...
resource "aws_vpc" "cn03_allowed_02" {
  ...
  tags = merge(var.common_tags, {
    Name      = "finos-ccc-integration-${var.deployment_suffix}-vpc-cn03-allowed-02"
    PeerClass = "allowed"
  })
}
...
resource "aws_vpc" "cn03_disallowed_01" {
  ...
  tags = merge(var.common_tags, {
    Name      = "finos-ccc-integration-${var.deployment_suffix}-vpc-cn03-disallowed-01"
...
resource "aws_vpc" "cn03_disallowed_02" {
  ...
  tags = merge(var.common_tags, {
    Name      = "finos-ccc-integration-${var.deployment_suffix}-vpc-cn03-disallowed-02"
    PeerClass = "disallowed"
  })
}
...
resource "aws_vpc" "cn03_non_allowlisted" {
  ...
  tags = merge(var.common_tags, {
    Name = "finos-ccc-integration-${var.deployment_suffix}-vpc-cn03-non-allowlisted-01"
  })
}
...
resource "aws_iam_role" "flow_logs" {
  name = "finos-ccc-integration-${var.deployment_suffix}-cn04-flowlogs-role"
...
resource "aws_iam_role_policy" "flow_logs" {
  name = "finos-ccc-integration-${var.deployment_suffix}-cn04-flowlogs-policy"
