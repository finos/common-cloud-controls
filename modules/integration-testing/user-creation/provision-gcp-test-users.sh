...
# Run from anywhere:
#   ./modules/integration-testing/user-creation/provision-gcp-test-users.sh
# Then:
#   source modules/integration-testing/user-creation/gcp-env.sh
set -euo pipefail
...

{
  ...
  echo "#   source modules/integration-testing/user-creation/gcp-env.sh"
  echo ""
