...
# Run from anywhere:
#   ./modules/integration-testing/user-creation/provision-azure-test-users.sh
# Then:
#   source modules/integration-testing/user-creation/azure-env.sh
set -euo pipefail
...

{
  ...
  echo "#   source modules/integration-testing/user-creation/azure-env.sh"
  echo ""
